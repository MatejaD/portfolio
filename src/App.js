...
export default function App() {
  ...
  return (<main className="font-text w-screen h-screen relative flex justify-around items-center gap-6 bg-background text-white">
   ...
   <Sidebar/>
      ...
      <div className={`${h? 'M' : ''}`}>
        ...
        className=" hover:text-blue">H</span>
      </div>
      ...
      <div className={`${i? 'M' : ''}`}>
        ...
        className=" hover:text-blue">i,</span>
      </div>
        </article>
  ...
  <div className="flex">
      ...
      <div className={`${m2? 'M' : ''}`}>
        ...
        className=" hover:text-blue">m</span>
      </div>
...
<div className="flex">
 ...
 <div className={`${m3? 'M' : ''}`}>
       ...
       <div className={`${a? 'M' : ''}`}>
        ...
        className=" hover:text-blue">a</span>
      </div>
       ...
       <div className={`${t? 'M' : ''}`}>
        ...
        className=" hover:text-blue">t</span>
      </div>
       ...
       <div className={`${e? 'M' : ''}`}>
        ...
        className=" hover:text-blue">e</span>
      </div>
       ...
       <div className={`${j? 'M' : ''}`}>
        ...
        className=" hover:text-blue">j</span>
      </div>
...
<article className="w-full flex gap-4">
 ...
 <div className={`${f? 'M' : ''}`}>
        ...
        className=" hover:text-blue">F</span>
      </div>
       ...
       <div className={`${r? 'M' : ''}`}>
        ...
        className=" hover:text-blue">r</span>
      </div>
       ...
       <div className={`${o? 'M' : ''}`}>
        ...
        className=" hover:text-blue">o</span>
      </div>
       ...
       <div className={`${n? 'M' : ''}`}>
        ...
        className=" hover:text-blue">n</span>
      </div>
       ...
       <div className={`${d? 'M' : ''}`}>
        ...
        className=" hover:text-blue">d</span>
      </div>
  ...
  <div className="flex">
      ...
      <div className={`${v? 'M' : ''}`}>
        ...
        className=" hover:text-blue">v</span>
      </div>
      ...
      <div className={`${l? 'M' : ''}`}>
        ...
        className=" hover:text-blue">l</span>
      </div>
      ...
      <div className={`${p? 'M' : ''}`}>
        ...
        className=" hover:text-blue">p</span>
      </div>
...
<p className="text-sm opacity-40">Frontend Dev / React / Firebase</p>

<button className="w-36 h-12 rounded-md border text-lg">Contact Me</button>

      </article>

      <div className="w-1/3 h-2/3 flex justify-center items-center ">
        <img className="w-full rotate-6" src={letter} alt="" />
      </div>
